...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.Manca-Bot','white'),color('Manca','red'),color('Fadli','white'),color('Nurul-Manca','yellow'))
})
           ...
           return false
            ...
            case 'bitly':
               ...
               case 'help': 
         	   ...
         	   case 'owner':
         	   case 'creator':
                  client.sendMessage(from, {displayname: "MancaCans", vcard: vcard}, MessageType.contact, { quoted: mek})
           ...
           case 'demote':
				...
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴀɴᴄᴀ-ʙᴏᴛ 」*\n\n${body.slice(4)}`)
						}
						reply('𝙨𝙪𝙘𝙘𝙚𝙨𝙨 𝙗𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩 ')
					}
					break
